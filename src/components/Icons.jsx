...
export const FacebookIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={`w-full h-auto ${className}`}
  >
    <path d="M23 12c0-6.627-5.373-12-12-12S-1 5.373-1 12A12.033 12.033 0 0 0 9.219 23.91v-8.457H6.156v-3.485h3.063v-2.3c0-3.036 1.8-4.712 4.571-4.712 1.32 0 2.753.235 2.753.235v3.032H14.99c-1.527 0-2.004.948-2.004 1.924v2.313h3.41l-.544 3.485h-2.866V24C18.578 23.032 23 18.039 23 12" />
  </svg>
);
